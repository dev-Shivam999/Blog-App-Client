...
const Nav = memo(({ val, show, val2 }: { val: boolean, show: true | false, val2: string }) => {
    ...
    return (
        <  >
            {
                !show &&
                <ul className='flex flex-wrap items-center my-5 font-semibold  justify-between w-full'>
                    <li>
                    ...
                    <li>
                        <Link to={'/Message'}>
                            <AiOutlineMessage className=' sm:w-[22.5vw] sm:h-[25vw]  md:w-[10vw] md:h-[10vw]' />
                        </Link>
                    </li>
                    <li>
